			...
			<div className='burger-menu__wrapper'>
				...
				<nav className='header__nav_placed_burger-menu'>
					...
					<div className='header__profile-container header__profile-container_placed_burger-menu' >
						<Link to='/profile' className='header__profile-button-text' onClick={handleOpenBurgerMenu}>Аккаунт</Link>
						<Link to='/profile' className='header__auth-profile button_placed_profile-container' onClick={handleOpenBurgerMenu}></Link>
					</div>
				</nav>
			</div>
		</div>
